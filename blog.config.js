...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://laureshang.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '尚雯婕粉丝共创工作室', // 网站关键词 英文逗号隔开
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 10000, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 10000, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-RV9R3LV298', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-1632984415942092', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '6721539873', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '7874839443', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '8626987210', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '6453946561', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '尚雯婕粉丝共创工作室', // 站点描述，被notion中的页面描述覆盖
